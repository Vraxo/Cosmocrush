namespace Nodica
{
    public class NavigationAgent : Node2D
    {
        ...
        // The threshold for when the target is considered to have moved far enough to trigger pathfinding.
        private const float TargetMoveThreshold = 1.0f; // Adjust as needed
        ...
        private void UpdatePath()
        {
            ...
            // Remove the check for whether the agent is already at the target.
            // Instead, we just calculate the path continuously towards the target position.
