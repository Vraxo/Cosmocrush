...
public class Panel : ClickableRectangle
{
    ...
    public HorizontalAlignment TitleHorizontalAlignment = HorizontalAlignment.Center;
    public VerticalAlignment TitleVerticalAlignment = VerticalAlignment.Center;
    ...
    private void DrawTitle()
    {
        DrawText(
            Title,
            GetTitlePosition(),
            FontManager.Instance.Get("Res/Cherris/Fonts/RobotoMono:32"),
            16,
            0,
            Color.White);
    }
    ...
    private Vector2 GetTitlePosition()
    {
        Vector2 titleSize = Font.MeasureText(
            ResourceLoader.Load<Font>("Res/Cherris/Fonts/RobotoMono:32"),
            Title,
            16,
            0);
