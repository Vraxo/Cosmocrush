...
public class RangedEnemy : RigidBody
{
    ...
    private const float ProximityThreshold = 320f;
    private const float DamageRadius = ProximityThreshold;
    ...
    private void ChasePlayer()
    {
        ...
        if (player is null || navigationAgent.Path.Count == 0 || IsTooCloseToPlayer())
        {
            return;
        }
    ...
    {
        return GlobalPosition.DistanceTo(player!.GlobalPosition) < ProximityThreshold;
    }
    ...
    private void AttemptToDamagePlayer()
    {
        ...
        projectile.Direction = player.GlobalPosition;
